# RESTful API : Users list app


By running a single command, you will get a production-ready Node.js TypeScript users list app installed and fully configured on your machine. The app has many features, such as authentication using JWT, request validation, unit and integration tests, continuous integration, docker support, API documentation, pagination, etc. For more details, check the features list below.
...
```bash
git clone --depth 1 https://github.com/rahul1368/opika-backend.git
cd opika-backend
```
...
# Deploying Dockerized NodeJS Application to AWS: Step-by-Step Guide
